...
- **BOOLEAN** — в данной реализации не используется, но мог бы применяться для флаговых значений (например, is_digital_copy, is_limited_edition). Занимает 1 байт и оптимален для хранения двоичных состояний.
